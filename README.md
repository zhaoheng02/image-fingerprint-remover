...
- `AIRTAP_PERSONAL_ACCESS_TOKEN`, optional `AIRTAP_BASE_URL`, `AIRTAP_XHS_MODEL_ID`, and `AIRTAP_RECEIVER_ID` — let the backend create the separate Xiaohongshu publish Airtap task after the WeChat approval link is confirmed
